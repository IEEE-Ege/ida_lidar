#include "ida_lidar/BuoyLidarNode.hpp"
...
BuoyLidarNode::BuoyLidarNode() : Node("buoy_lidar")
{
...
BuoyLidarNode::Color BuoyLidarNode::colorByRange(float distance)
{
...
void BuoyLidarNode::lidarCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
{
    // ----------------------------------------------------------------
